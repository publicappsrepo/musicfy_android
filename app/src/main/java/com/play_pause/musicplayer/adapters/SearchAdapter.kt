...
import com.play_pause.musicplayer.extensions.glide.*
import com.play_pause.musicplayer.extensions.media.*
...
class SearchAdapter(
    ...
    inner class ViewHolder(itemView: View, itemViewType: Int) :
        com.play_pause.musicplayer.adapters.base.MediaEntryViewHolder(itemView) {
