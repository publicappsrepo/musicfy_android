...
package com.play_pause.musicplayer.fragments.player
...
import com.play_pause.musicplayer.adapters.pager.AlbumCoverPagerAdapter
import com.play_pause.musicplayer.databinding.FragmentPlayerAlbumCoverBinding
import com.play_pause.musicplayer.extensions.currentFragment
import com.play_pause.musicplayer.extensions.isLandscape
import com.play_pause.musicplayer.extensions.keepScreenOn
...
import com.play_pause.musicplayer.fragments.lyrics.LyricsFragment
import com.play_pause.musicplayer.fragments.lyrics.LyricsViewModel
import com.play_pause.musicplayer.fragments.player.base.goToDestination
...
import com.play_pause.musicplayer.model.theme.NowPlayingScreen
import com.play_pause.musicplayer.service.MusicPlayer
import com.play_pause.musicplayer.transform.CarousalPagerTransformer
import com.play_pause.musicplayer.transform.ParallaxPagerTransformer
import com.play_pause.musicplayer.util.LEFT_RIGHT_SWIPING
import com.play_pause.musicplayer.util.LYRICS_ON_COVER
...
class PlayerAlbumCoverFragment : AbsMusicServiceFragment(), ViewPager.OnPageChangeListener,
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String?) {
        when (key) {
            LYRICS_ON_COVER -> {
//                val isShowLyrics = sharedPreferences.getBoolean(key, false)
//                val isShowLyrics = false
