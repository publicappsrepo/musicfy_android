...
package com.play_pause.musicplayer.http.github
...
import com.play_pause.musicplayer.extensions.files.asReadableFileSize
import com.play_pause.musicplayer.extensions.packageInfo
...
class GitHubRelease(
    ...
    class ReleaseAsset(
        ...
        val isApk: Boolean
            get() = contentType == APK_MIME_TYPE && name.contains("android")
